...
| 功能模块 | 优先级 | 说明 |
|---------|--------|------|
| 核心流媒体 | P0 | 视频/音频流接收与渲染 |
| PS 主机发现 | P0 | 局域网自动发现 PS4/PS5 |
| 主机唤醒 | P0 | Wake-on-LAN 功能 |
| 控制器支持 | P0 | DualShock 4 / DualSense 支持 |
| PSN 账户登录 | P1 | 远程连接所需的账户认证 |
| 远程连接 | P1 | 通过互联网连接 PS 主机 |
| 触觉反馈 | P2 | DualSense 触觉反馈支持 |
| 麦克风支持 | P2 | 语音聊天功能 |
| 键盘/触摸板 | P3 | 虚拟输入支持 |
